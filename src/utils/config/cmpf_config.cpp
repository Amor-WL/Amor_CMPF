...
int CmpfConfig::GetInt(const std::string& key) const {
    return GetInt(key, 0);
}
...
std::string CmpfConfig::GetString(const std::string& key) const {
    return GetString(key, "");
}

std::string CmpfConfig::GetString(const std::string& key,
...
bool CmpfConfig::GetBool(const std::string& key) const {
